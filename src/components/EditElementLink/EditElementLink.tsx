...
import { lookupSchema } from "../CreateElementsLinksForm/CreateElementsLinksForm";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faCheck } from "@fortawesome/free-solid-svg-icons";
import { handleBeforeUnload } from "../../utils";
const EditElementLink = ({
  toggle,
  toggleSecond,
  linkId,
}: {
  ...
  const { loading, singleElementLink } = useAppSelector(
  ...
  useEffect(() => {
    if (singleElementLink)
      setValue(
        "amountType",
        singleElementLink?.amountType === "fixed" ? "fixed" : "rated"
      );
  }, [singleElementLink, setValue]);

  useEffect(() => {
    if (singleElementLink && singleElementLink?.suborganizationId)
      setValue("suborganizationId", singleElementLink?.suborganizationId);

    if (singleElementLink && singleElementLink?.departmentId)
      setValue("departmentId", singleElementLink?.departmentId);
  }, [singleElementLink, setValue]);

  useEffect(() => {
    if (singleElementLink && singleElementLink?.grade)
      setValue("grade", singleElementLink?.grade);

    if (singleElementLink && singleElementLink?.gradeStep)
      setValue("gradeStep", singleElementLink?.gradeStep);
  }, [singleElementLink, setValue]);
    ...
    <>
      <div className={Styles.textarea}>
        ...
        <input
          ...
          defaultValue={singleElementLink?.name}
        />
        <ErrorMessage
          errors={errors}
          name="name"
      ...
      <div className={Styles.con}>
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.suborganizationId}
          >
        ...
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.departmentId}
          >
      ...
      <div className={Styles.con}>
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.jobTitleId}
          >
        ...
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.locationId}
          >
      ...
      <div className={Styles.con}>
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.employeeTypeValueId}
          >
        ...
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.employeeCategoryValueId}
          >
    ...
    <>
      <div className={Styles.con}>
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.grade}
          >
        ...
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.gradeStep}
          >
      ...
      <div className={Styles.textarea}>
        ...
        <select
          ...
          defaultValue={singleElementLink?.unionId}
        >
        ...
        <div className={Styles.con}>
          <div className={Styles.item}>
            ...
            <select
              ...
              defaultValue={
                singleElementLink?.additionalInfo.find(
      ...
      <div className={Styles.con}>
        <div className={Styles.item}>
          ...
          <select
            ...
            defaultValue={singleElementLink?.amountType}
          >
            ...
            {watch("amountType") === "fixed" && (
              <div className={Styles.item}>
                ...
                <input
                  ...
                  defaultValue={singleElementLink?.amount}
                />
                <ErrorMessage
                  errors={errors}
                  name="amount"
            ...
            {watch("amountType") === "rated" && (
              <div className={Styles.item}>
                ...
                <input
                  ...
                  defaultValue={singleElementLink?.rate}
                />
                <ErrorMessage
                  errors={errors}
                  name="amount"
      ...
      <div className={Styles.con}>
        <div className={Styles.item}>
          ...
          <input
            ...
            defaultValue={
              singleElementLink?.effectiveStartDate &&
              new Date(singleElementLink?.effectiveStartDate)
                .toISOString()
                .split("T")[0]
            }
          />
        ...
        <div className={Styles.item}>
          ...
          <input
            ...
            defaultValue={
              singleElementLink?.effectiveEndDate &&
              new Date(singleElementLink?.effectiveEndDate)
                .toISOString()
                .split("T")[0]
            }
          />
          ...
          <div className={`${Styles.pan_} `}>
            ...
            >
              <input
                ...
                defaultChecked={singleElementLink?.status === "active"}
              />
              <span
  ...
  return (
    <>
      ...
      {!loading && singleElementLink ? (
        ...
        <> {!loading && <p>Issues fetching element link</p>} </>
      )}
    </>
  );
};
